...
export function ScreeningPanel({ movie, screenings, selectedScreeningId, onScreeningSelect }: ScreeningPanelProps) {
  return (
    <section className="panel" aria-labelledby="screenings-title">
      ...
      <div className="screening-list" aria-label="Screening times">
        {screenings.map((screening) => (
          ...
          >
            <span className="screening-button__time">{formatScreeningTime(screening.startsAt)}</span>
