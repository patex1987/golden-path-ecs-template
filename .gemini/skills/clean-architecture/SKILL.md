...
description: Use when designing or refactoring service architecture around clean architecture, SOLID principles, dependency injection, and clear layer boundaries.
---
